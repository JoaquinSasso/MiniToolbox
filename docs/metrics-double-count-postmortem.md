...
3. **Reproducción**: Se confirmó mediante inspección de logs en el emulador de Firebase que un único evento de "app start" en el cliente disparaba dos incrementos atómicos sobre la misma clave en la base de datos.
...
- Añadir un banner de advertencia: *"Las aperturas previas a la corrección del 2025-10-24 contienen un doble conteo sistemático"*.
